...
- сценарий собственной публикации с текстом и изображением;
...
В Figma запустите поток **NeuroCafe Сообщество**. Он начинается с обновлённой ленты `906:1138` и включает собственную публикацию, вложение, комментарий, поддержку, репост и состояния результата. Резервная копия исходных экранов вынесена на страницу **Backup / NeuroCafe / 2026-08-28**.
